...
import Ex02.Enums.TamanhoPizza;
import Ex02.Ingredientes.*;
...
public class Pizza {
    ...
    public void adicionarIngredientePizza(Ingrediente ingredienteNovo, double quantidade) throws IOException {
        ...
        LoggerPizza loggerAdicionar = LoggerPizza.getInstance("logIngredientes.txt");
    ...
    public void removerIngredientePizza(int idRemover) throws IOException {
        ...
        LoggerPizza loggerRemocao = LoggerPizza.getInstance("loggerIng.txt");
    ...
    public double calcularKcalTotais() throws IOException {
        ...
        LoggerPizza loggerKcal = LoggerPizza.getInstance("LoggerIngredientes.txt");
