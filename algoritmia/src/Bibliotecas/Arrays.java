...
public class Arrays {
    ...
    public static int[] lerVetorInteiros(int tamanho) {
        ...
        // Ler vetor
        for (int i = 0; i < vetorPreencher.length; i++) { //dava para por tamanho em vez de vetor<preencher.length, mas se por algum motivo o vetor nao for inicializado com tamanho, vetorpreencher.length traduz o verdadeiro valor do vetor
