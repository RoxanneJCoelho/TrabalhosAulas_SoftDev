...
public class Main {
    public static void main(String[] args) {
        ...
        Carne pepperoni = new Carne(55, "Pepperoni", UnidadeMedida.UNIDADES, 20, OrigemIngrediente.IMPORTADO, TipoCarne.FRANGO);

        FrutoMar camarao = new FrutoMar(33, "Camarão Tigre", UnidadeMedida.UNIDADES, 50, OrigemIngrediente.IMPORTADO, TipoFrutosMar.CAMARAO);
